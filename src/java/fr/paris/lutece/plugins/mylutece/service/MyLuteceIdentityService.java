...
public class MyLuteceIdentityService implements IMyLuteceIdentityService
{
    ...
    private static final String BEAN_MY_LUTECE_IDENTITY_SERVICE="mylutece.myLuteceIdentityService";
    private static volatile IMyLuteceIdentityService _singleton;
    private static final String SEPARATOR = ",";
   

    /**
     * Get the instance of the MyLuteceIdentityService  service
     * 
     * @return the instance of the MyLuteceIdentityService  service
     */
    public static IMyLuteceIdentityService getInstance( )
    {
        if ( _singleton == null )
        {
            synchronized( IMyLuteceIdentityService.class )
            {
                IMyLuteceIdentityService service = SpringContextService.getBean(BEAN_MY_LUTECE_IDENTITY_SERVICE ); 
                _singleton = service;
    ...
    public Map<String,String>getIdentityInformations(String strUserName,Map<String, List<String>> attributeUserMappings)
    {
        ...
        for ( IMyLuteceIdentityProviderService identityProviderService : SpringContextService.getBeansOfType( 
                IMyLuteceIdentityProviderService.class ) )
        {
